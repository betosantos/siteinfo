...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <!-- Title -->
        <h1 class="mt-4">{{ $postbycat->titulo }}</h1>
        <!-- Author -->
        <!-- <p class="lead">
        by
      ...
      <!-- Date/Time -->
      <p><b>Criado em: {{ $postbycat->created_at }}</b></p>
      <hr>
      <!-- Preview Image -->
      @if ($postbycat['imagem'])
      <img class="img-fluid rounded" src="{{ asset('uploads/posts/'.$postbycat->imagem) }}" class="card-img-top" alt="card">
      @else
      ...
      <blockquote class="blockquote">
        <p class="mb-0">{{ $postbycat->descricao }}</p>
      </blockquote>
      <hr>
